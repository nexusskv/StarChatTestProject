...
- (void)updateFramesForAuthorType:(AuthorType)type
{
	...
	CGRect freshRect = CGRectZero;
    
	if (self.imageView.image) {
        freshRect = [self.textLabel.text boundingRectWithSize:CGSizeMake(self.frame.size.width - minInset - STBubbleWidthOffset - STBubbleImageSize - 8.0f, CGFLOAT_MAX)
                                                      options:NSStringDrawingUsesLineFragmentOrigin
                                                   attributes:@{NSFontAttributeName : self.textLabel.font}
                                                      context:nil];
    } else {
        freshRect = [self.textLabel.text boundingRectWithSize:CGSizeMake(self.frame.size.width - minInset - STBubbleWidthOffset, CGFLOAT_MAX)
                                                      options:NSStringDrawingUsesLineFragmentOrigin
                                                   attributes:@{NSFontAttributeName : self.textLabel.font}
                                                      context:nil];
    }
    
    CGSize freshSize = freshRect.size;
	
	// You can always play with these values if you need to
	if(type == STBubbleTableViewCellAuthorTypeSelf)
	{
		if (self.imageView.image) {
			self.bubbleView.frame = CGRectMake(self.frame.size.width - (freshSize.width + STBubbleWidthOffset) - STBubbleImageSize - 8.0f, self.frame.size.height - (freshSize.height + 15.0f), freshSize.width + STBubbleWidthOffset, freshSize.height + 15.0f);
			...
			self.textLabel.frame = CGRectMake(self.frame.size.width - (freshSize.width + STBubbleWidthOffset - 10.0f) - STBubbleImageSize - 8.0f, self.frame.size.height - (freshSize.height + 15.0f) + 6.0f, freshSize.width + STBubbleWidthOffset - 23.0f, freshSize.height);
		} else {
			self.bubbleView.frame = CGRectMake(self.frame.size.width - (freshSize.width + STBubbleWidthOffset), 0.0f, freshSize.width + STBubbleWidthOffset, freshSize.height + 15.0f);
			self.imageView.frame = CGRectZero;
			self.textLabel.frame = CGRectMake(self.frame.size.width - (freshSize.width + STBubbleWidthOffset - 10.0f), 6.0f, freshSize.width + STBubbleWidthOffset - 23.0f, freshSize.height);
		}
		...
		if (self.imageView.image) {
			self.bubbleView.frame = CGRectMake(STBubbleImageSize + 8.0f, self.frame.size.height - (freshSize.height + 15.0f), freshSize.width + STBubbleWidthOffset, freshSize.height + 15.0f);
			self.imageView.frame = CGRectMake(5.0, self.frame.size.height - STBubbleImageSize - 2.0f, STBubbleImageSize, STBubbleImageSize);
			self.textLabel.frame = CGRectMake(STBubbleImageSize + 8.0f + 16.0f, self.frame.size.height - (freshSize.height + 15.0f) + 6.0f, freshSize.width + STBubbleWidthOffset - 23.0f, freshSize.height);
		} else {
			self.bubbleView.frame = CGRectMake(0.0f, 0.0f, freshSize.width + STBubbleWidthOffset, freshSize.height + 15.0f);
			self.imageView.frame = CGRectZero;
			self.textLabel.frame = CGRectMake(16.0f, 6.0f, freshSize.width + STBubbleWidthOffset - 23.0f, freshSize.height);
		}
